...
const data = PRODUCTS["elencofix-super"];

const SITE = "https://agriprompakistan.com";
const PATH = "/products/poultry/elencofix-super";
const URL = `${SITE}${PATH}`;
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Toxin Binders", item: `${SITE}/products/poultry` },
    { "@type": "ListItem", position: 5, name: data.name, item: URL },
  ],
};

export default function ElencoFixSuperPage() {
  return (
    <>
