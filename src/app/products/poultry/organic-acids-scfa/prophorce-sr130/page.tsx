...
const data = PRODUCTS["prophorce-sr130"];

const SITE = "https://agriprompakistan.com";
const PATH = "/products/poultry/organic-acids-scfa/prophorce-sr130";
const URL = `${SITE}${PATH}`;
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Organic Acids (SCFA)", item: `${SITE}/products/poultry` },
    { "@type": "ListItem", position: 5, name: data.name, item: URL },
  ],
};

export default function ProPhorceSr130Page() {
  return (
    <>
      <script
