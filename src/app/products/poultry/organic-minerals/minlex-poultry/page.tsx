...
const data = PRODUCTS["minlex-poultry"];

const SITE = "https://agriprompakistan.com";
const PATH = "/products/poultry/organic-minerals/minlex-poultry";
const URL = `${SITE}${PATH}`;
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Organic Minerals", item: `${SITE}/products/poultry` },
    { "@type": "ListItem", position: 5, name: data.name, item: URL },
  ],
};

export default function MinlexPoultryPage() {
  return (
    <>
